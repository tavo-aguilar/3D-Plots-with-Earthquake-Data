...
-Another figure can be generated by using the plotly package on the same dataset. The package makes the dataset interactive and allows us to select points on the figure if we choose. The output from this package looks as so:
